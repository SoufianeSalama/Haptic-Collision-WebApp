                ...
                <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6" >
                                <div class="form-group" style="width: 100%; margin-top: 15px;">
                                    ...
                                    <label for="frmRegisterFunction">Function</label>
                                    <select name="frmRegisterFunction" id="frmRegisterFunction" class="form-control">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6"style="text-align: right;">
                                <div class="form-group" style="width: 100%; margin-top: 15px;">
                                    ...
                                    <label for="frmRegisterSurgicalExperience">Surgical Experience</label>
                                    <select name="frmRegisterSurgicalExperience" id="frmRegisterSurgicalExperience" class="form-control">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6" >
                                <div class="form-group" style="width: 100%; margin-top: 15px;">
                                    <label for="frmRegisterWorkplace">Workplace</label>
                                    <input type="text" name="frmRegisterWorkplace" id="frmRegisterWorkplace"  class="form-control" placeholder="UZ Leuven" value="<?php echo set_value('frmRegisterWorkplace'); ?>">
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6" style="text-align: right;">
                                <div class="form-group" style="width: 100%; margin-top: 15px;">
                                    <label for="frmRegisterPhone">Phone</label>
                                    <input type="tel" name="frmRegisterPhone" id="frmRegisterPhone"  class="form-control" placeholder="+32481111111" value="<?php echo set_value('frmRegisterPhone'); ?>" >
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="width: 100%; margin-top: 15px;">
                        ...
                        <label for="frmRegisterCountry">Country</label>
                        <select name="frmRegisterCountry" id="frmRegisterCountry" class="form-control">
                    ...
                    <div class="form-group" style="width: 100%; margin-top: 15px;">
                        ...
                        <input type="password" name="frmRegisterPassword" id="frmRegisterPassword" class="form-control" value="<?php echo set_value('frmRegisterPassword'); ?>" >
                    </div>
