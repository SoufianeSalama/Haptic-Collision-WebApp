...
<!--[if mso]></td></tr></table><![endif]-->
	...
	<div style="line-height:180%;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;color:#555555; padding-right: 25px; padding-left: 25px; padding-top: 25px; padding-bottom: 5px;">	
		<div style="line-height:22px;font-size:12px;color:#555555;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;text-align:left;"><p style="margin: 0;line-height: 22px;text-align: center;font-size: 12px"><span style="font-size: 18px; line-height: 32px;">Dear admin</span></p><p style="margin: 0;line-height: 22px;text-align: center;font-size: 12px">&#160;<br></p><p style="margin: 0;line-height: 22px;text-align: center;font-size: 12px"><span style="font-size: 18px; line-height: 32px;"><?php echo $firstname;?> <?php echo $lastname;?> (<?php echo $email;?>) has signed up with Ortho Analyzer.</span></p><p style="margin: 0;line-height: 22px;text-align: center;font-size: 12px">&#160;<br></p><p style="margin: 0;line-height: 22px;text-align: center;font-size: 12px"><span style="font-size: 18px; line-height: 32px;">This is the user information</span></p><p style="margin: 0;line-height: 22px;text-align: center;font-size: 12px"><span style="font-size: 18px; line-height: 32px;">First name: <?php echo $firstname; ?><br> Last name: <?php echo $lastname;?><br> E-mail: <?php echo $email;?><br> Function: <?php echo $function;?><br> Workplace: <?php echo $workplace;?><br> Country: <?php echo $country;?><br> Phone: <?php echo $phone;?><br> Surgical Experience: <?php echo $surgical_experience;?><br> Username: <?php echo $username;?></span></p><p style="margin: 0;line-height: 22px;text-align: center;font-size: 12px">&#160;<br></p><p style="margin: 0;line-height: 22px;text-align: center;font-size: 12px"><span style="font-size: 18px; line-height: 32px;">Please click the button below to approve this account.</span></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<div align="center" class="button-container center " style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;">
  <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="'.$url.'" style="height:40pt; v-text-anchor:middle; width:188pt;" arcsize="8%" strokecolor="#7ac4d5" fillcolor="#7ac4d5"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif; font-size:22px;"><![endif]-->
	<a href="<?php echo $url;?>" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #7ac4d5; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; max-width: 251px; width: 211px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 20px; padding-bottom: 5px; padding-left: 20px; font-family: 'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;mso-border-alt: none">
